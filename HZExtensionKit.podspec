#
#  Be sure to run `pod spec lint HZExtensionKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "History"
  # s.authors            = { "History" => "history_zq@163.com" }
  # s.social_media_url   = "http://twitter.com/History"
 ...
 s.platform     = :ios, "6.0"
  ...
  # s.exclude_files = "HZExtensionKit"
